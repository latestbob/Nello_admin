...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Health Tip View</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('health-tip-view', ['uuid' => $uuid]) }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title"
                                           value="{{ old('title', $tip->title) }}" name="title" placeholder="Enter title"/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote-basic" class="form-control @error('body') is-invalid @enderror"
                                         name="body" placeholder="Enter body">{{ old('body', $tip->body) }}</textarea>
                                    @error('body')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('date') is-invalid @enderror"
                                           id="date" data-toggle="date-picker" data-format="dd-mm-yyyy"
                                           value="{{ old('date', \Carbon\Carbon::createFromFormat('Y-m-d', $tip->date)->format('d-m-Y')) }}"
