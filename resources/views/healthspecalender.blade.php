    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Calendar for {{\App\Models\HealthCenter::where("uuid",$specialization->med_center_uuid)->value("name")}} - {{$specialization->specialization}}</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('deleteuniquehealthcenterspec',$dates->id)}}"method="POST">
                                                ...
                                                <button class="btn btn-danger text-light">Remove</button>||<a href="{{route('healthcenterspecdatetime',$dates->id)}}"class="btn btn-info text-center text-light">Manage Time</a>
                                            </form>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('healthcenterspecpost')}}"method="POST">
          @csrf 

        
          <input type="hidden"name="center_uuid"value="{{$specialization->med_center_uuid}}">
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4 class="font-weight-bold">Are you sure you want to delete all  calendar for {{$specialization->specialization}} ?</h4>
      <p style="font-size:17px;">Please note that this will delete the entire calendar and associated time.</p>
        
      <form action="{{route('healthdeleteallcalenderdateandtime',$specialization->id)}}"method="POST">
          @csrf 
          {{method_field('DELETE')}}
