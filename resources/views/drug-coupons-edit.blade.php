...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('coupons-edit', ['coupon' => $coupon->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           id="name"
                                           value="{{ old('name', $coupon->name) }}" name="name" placeholder="Enter name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror"
                                           id="code"
                                           value="{{ old('code', $coupon->code) }}" name="code" placeholder="Enter code">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="type" name="type" class="form-control @error('type') is-invalid @enderror">
                                        ...
                                        <option value="amount" @if(old('type', $coupon->type) == 'amount') selected @endif >Amount</option>
                                    </select>
