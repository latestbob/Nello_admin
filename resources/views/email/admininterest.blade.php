...
<table id="u_content_heading_1" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 20px;">
    <div>
<div><strong style="color:white;">New Interest Received</strong></div>
</div>
  </h1>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="font-size: 13px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;color:white;">Dear Support, <br><br>
      ...
      A new Interest has been sent by {{$admininterest["name"]}} , with email address of {{$admininterest['email']}} , business type is {{$admininterest['type']}} and is interested in joining Nello for {{$admininterest['interest']}} . <br><br>

      Other Relevant information is as follows : <br>

      {{$admininterest['others']}} <br><br>

      Kindly go to the admin dashboard to see full details of the interest.
