!function (a) {
    ...
    t.prototype._resetSidebarScroll = function () {
        ...
        var t = a("#left-side-menu-container");
        t.slimScroll({destroy: !0}), t.removeClass("slimscroll-menu"), t.removeAttr("style"), this._resetSidebarScroll()
    }, t.prototype.deactivateScrollableSidebar = function () {
        this.body.removeAttr("data-leftbar-compact-mode"), a("#left-side-menu-container").addClass("slimscroll-menu"), this._resetSidebarScroll()
        ...
        var e = this;
        this._reset(), a(".side-nav").metisMenu(), this.body.hasClass("scrollable-layout") && a("#left-side-menu-container").removeClass("slimscroll-menu"), this._resetSidebarScroll(), a(document).on("click", ".button-menu-mobile", function (t) {
        ...
        }), a.fn.slimScroll && a(".slimscroll").slimScroll({
            height: "auto",
            position: "right",
            size: "5px",
            touchScrollStep: 20,
    ...
    t.prototype.initMenu = function () {
        e(".topnav-menu li a").each(function () {
            var t = window.location.href.split(/[?#]/)[0];
            this.href == t && (e(this).addClass("active"), e(this).parent().parent().addClass("active"), e(this).parent().parent().parent().parent().addClass("active"), e(this).parent().parent().parent().parent().parent().parent().addClass("active"))
    ...
    t.prototype._saveConfig = function (t) {
        a.extend(this._config, t), sessionStorage.setItem("_HYPER_CONFIG_", JSON.stringify(this._config))
    }, t.prototype._getStoredConfig = function () {
        var t = sessionStorage.getItem("_HYPER_CONFIG_");
        ...
        if (767 <= this.window.width() && this.window.width() <= 1028) this.activateCondensedSidebar(!0); else {
        ...
        sessionStorage.removeItem("_HYPER_CONFIG_"), this._config = n
        ...
        var t = a("body").data("layout");
        t && "topnav" === t && a.Topbar.init()
    ...
    t.prototype.initSelect2 = function () {
        ...
        n('[data-toggle="date-picker-range"]').each(function (t, e) {
            var sd = n(e).data('date-start'), ed = n(e).data('date-end');
            o.startDate = sd && sd.length > 0 ? moment(sd, "YYYY-MM-DD") : o.startDate
            o.endDate = ed && ed.length > 0 ? moment(ed, "YYYY-MM-DD") : o.endDate
            var a = n.extend({}, o, n(e).data()), b = n(e)[0], i = a.targetDisplay;

            i && n(i).html(o.startDate.format("MMMM D, YYYY") + " - " + o.endDate.format("MMMM D, YYYY"));

            n(e).daterangepicker(a, function (t, e) {
                i && n(i).html(t.format("MMMM D, YYYY") + " - " + e.format("MMMM D, YYYY"));
                b.onchange && b.onchange({start: t, end: e});
            })
        })
    ...
    t.prototype.send = function (t, e, a, i, o, n, r, s) {
        var c = {heading: t, text: e, position: a, loaderBg: i, icon: o, hideAfter: n = n || 3e3, stack: r = r || 1};
        c.showHideTransition = s || "fade", d.toast().reset("all"), d.toast(c)
    }, d.NotificationApp = new t, d.NotificationApp.Constructor = t
}(window.jQuery), function (e) {
    "use strict";
    ...
    t.prototype.initTooltipPlugin = function () {
        ...
        e(document).ready(function (t) {
            document.querySelectorAll("pre span.escape").forEach(function (t, e) {
                if (t.classList.contains("escape")) var a = t.innerText; else a = t.innerText;
        ...
        this.initTooltipPlugin(), this.initPopoverPlugin(), this.initToastPlugin(), this.initSlimScrollPlugin(), this.initFormValidation(), this.initSyntaxHighlight()
    ...
    "use strict";
    t.App.init(), t.App.activateDarkSidebarTheme()
}(window.jQuery);
